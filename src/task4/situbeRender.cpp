	...
	*/
	...
	if ( m_curseloptidx == int(m_optPanel.m_buttons.size()) - 1 ) {
		...
		if ( m_strAnswer == "hit" ) {
			...
			m_strAnswer += " (wrong).";
			ostrprmpt << "not quite right, please look at the red box.\n";
			m_bIboxEnabled = true;
			m_boxes[0].setFrameColor(1,0,0);
		}
	...
	case GLUT_RIGHT_BUTTON:
		{
			...
			if ( m_strAnswer == "hit" ) {
				...
				ostrprmpt << "Not quite right, please see the red box.\n";
				m_bIboxEnabled = true;
				m_boxes[0].setFrameColor(1,0,0);
			}
