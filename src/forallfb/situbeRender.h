...
public:
	 ...
	 */
	void buildTubefromLine(unsigned long lineIdx, bool forfb=false);
...
private:
	...
	string m_strfnsrc; // this will be rendered as transparent as background context
	string m_strfnfg;  // this will be the non-transparent foreground geometry
	...
	vector< vector<GLfloat> >		m_fbtubevertices;
	vector< vector<GLfloat>	>		m_fbtubenormals;
	vector< vector<GLfloat>	>		m_fbtubecolors;
	vector< vector<GLfloat>	>		m_fbencodedcolors;
	vector< vector<GLuint> >		m_fbtubefaceIdxs;
